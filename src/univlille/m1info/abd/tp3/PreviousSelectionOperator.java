...
public class PreviousSelectionOperator implements PhysicalOperator {
	...
	public PreviousSelectionOperator(PhysicalOperator operator, String attrName, String constantValue, ComparisonOperator comparator) {
