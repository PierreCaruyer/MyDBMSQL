...
public class TestsTP6 {
	...
	public void testParcoursTable() throws IOException, NotEnoughMemoryException {
		...
		MemoryManager mem = new SimpleMemoryManager(2, 5);
	...
	public static List<String[]> getOperatorTuples(PhysicalOperator operator, MemoryManager mem) throws NotEnoughMemoryException {
		List<String[]> result = new ArrayList<>();
		operator.reset();
		int pageNb;
